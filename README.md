...
This repo contains bootstrap scripts / dotfiles / configurations for my system(s).

## Prerequisites

Ensure you have the following installed on your system:
- [git](https://git-scm.com/)
- [GNU Stow](https://www.gnu.org/software/stow/) (if you aren't using bootstrap scripts)
...
- [Configure your Git](https://www.youtube.com/watch?v=G3NJzFX6XhY)# dotfiles

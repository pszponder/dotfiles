- Add TMUX configs
- Resources to review:
	- https://github.com/rothgar/mastering-zsh/tree/master
	-
...
- [typecraft - This plugin makes you a Vim and TMUX GOD[(https://www.youtube.com/watch?v=qyV_hOtMdwg)
- [Dreams of Code - Tmux has forever changed the way I write code](https://www.youtube.com/watch?v=DzNmUNvnB04)

FZF
- [DevOps Toolbox - Fuzzy Finding Everything](https://www.youtube.com/watch?v=MvLQor1Ck3M)
...
- [GitHub Dotfiles Inspiration](https://dotfiles.github.io/inspiration/)
- [chris@machine - Dotfiles](https://github.com/ChristianChiarulli/Machfiles/tree/master)
- [awesome dotfiles](https://github.com/webpro/awesome-dotfiles)
- [mathiasbynens - dotfiles](https://github.com/mathiasbynens/dotfiles)
- [webpro dotfiles](https://github.com/webpro/dotfiles)
- [colinhebert - dotfiles](https://github.com/ColinHebert/dotfiles)
- [I do dotfiles!](https://github.com/jogendra/dotfiles)
